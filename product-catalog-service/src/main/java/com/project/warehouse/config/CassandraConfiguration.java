...
public class CassandraConfiguration extends CassandraDataAutoConfiguration{
    // constructor: BeanFactory, CassandraProperties, Cluster, Environment
    ...
    @Bean
    public CassandraMappingContext cassandraMappingContext(BeanFactory beanFactory, Cluster cluster, CassandraProperties properties) throws ClassNotFoundException {
