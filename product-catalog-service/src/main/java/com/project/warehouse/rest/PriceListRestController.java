...
import com.project.warehouse.hateoas.ProductsInPriceListHateoasFactory;
...
public class PriceListRestController {
    ...
    @Autowired
    private ProductsInPriceListHateoasFactory goodsInPriceListHeateoasFactory;
    ...
    public ResponseEntity createPriceList(@RequestBody PriceList priceList){
        ...
        return ResponseEntity.created(MvcUriComponentsBuilder.fromMethodName(PriceListRestController.class,
